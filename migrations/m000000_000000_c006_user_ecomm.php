...
class m000000_000000_c006_user_ecomm extends Migration
{
     ...
     *  ~ Console command ~
     *
     * php yii migrate --migrationPath=@vendor/c006/yii2-user-ecommerce/migrations
     *
     */
    ...
    public function up()
    {
        ...
        if (!in_array('user', $tables))  {
            if ($dbType == "mysql") {
                $this->createTable('{{%user}}', [
                    ...
                    'phone_carrier_id' => 'SMALLINT(5) UNSIGNED NULL',
        ...
        $this->execute('SET foreign_key_checks = 0');
        $this->insert('{{%user}}',['id'=>'1','network_id'=>'1','store_id'=>'1','username'=>'admin','auth_key'=>'CcqfH1ZuHo-HxdM-DK3yX4d0Z9SyNWUq','password_hash'=>'$2y$13$E2Cedx.IWufS03d6IgGe..TwDYZxTz1WpNi7/65ZqghlLr5nHXgvS','password_reset_token'=>'','email'=>'admin@admin.com','role'=>'10','status'=>'10','created_at'=>'0000-00-00 00:00:00','updated_at'=>'2015-09-14 08:04:04','phone'=>'','phone_sms'=>'0','phone_mms'=>'','phone_carrier_id'=>'0','first_name'=>'user','last_name'=>'admin','pin'=>'','pin_tries'=>'2','confirmed'=>'1']);
